...
import org.alicebot.ab.utils.ChineseUtils;
...
public class Graphmaster {
    ...
    public void addCategory (Category category) {
        ...
        if(!category.isSegment()){
            ...
            String _pattern= ChineseUtils.splitChinese(pattern);
            if(!pattern.equals(_pattern)){
                category.setPattern(_pattern);
                category.setSegment(true);
            }
